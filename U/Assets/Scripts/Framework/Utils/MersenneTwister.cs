...
namespace Framework
{
    ...
    public class MersenneTwisterRandom : System.Random
    {
        ...
        private UInt32[] _mag01 = new UInt32[] { 0, 0x9908b0df }; // used in generating next random number
        ...
        private void initialise(UInt32 seed)
        {
            ...
            _nextValueIndex = _stateVectorSize;
        }
        ...
        private UInt32 GenerateRandomValue()
        {
            ...
            if (_nextValueIndex >= _stateVectorSize)
            {
                int index;
            ...
            randValue = _stateVector[_nextValueIndex++];
